...
#your_favorite_word # Put a . after your_favorite word and use a String method.

puts "MY FAVORITE WORD IS "+favorite_word_in_all_caps#{favorite_word_in_all_caps}"
